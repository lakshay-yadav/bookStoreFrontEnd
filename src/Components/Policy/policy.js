...
export default function Policy() {
  return (
    <>
      ...
      <h1> Privacy Policy for Book Store</h1>
      <p>
        {" "}
      ...
      <p>
        At Book Store we consider the privacy of our visitors to be
        extremely important. This privacy policy document describes in detail
        the types of personal information is collected and recorded by Book store and how we use it.{" "}
      </p>
      <p>
        {" "}
        <b>Log Files</b>
        <br /> Like many other Web sites,  makes use of log
      ...
      <p>
        ...
        <br />
        Book Store uses cookies to store information about visitors'
      ...
      <p>
        → Google, as a third party vendor, uses cookies to serve ads on Book Store.
        <br />
        <br />
        → Google's use of the DART cookie enables it to serve ads to our site's
        visitors based upon their visit to Book Store and other sites on
        the Internet. <br />
      ...
      <p>
        <em>
          ...
          the advertising partners of Book Store.
        </em>
      </p>
      <p>
        {" "}
        These third-party ad servers or ad networks use technology in their
        respective advertisements and links that appear on Book Store and
      ...
      <p>
        {" "}
        Book Store has no access to or control over these cookies that are
      ...
      <p>
        ...
        online activity.
        <br />
        Book Store does not knowingly collect any personally identifiable
        information from children under the age of 13. If a parent or guardian
        believes that Book Store has in its database the
